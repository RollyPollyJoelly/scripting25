...
document.getElementById("city").innerHTML =
  " You have " + buildings + " Units in your city!";
//Functions --
...
function storageBuild() {
  ...
  document.getElementById("cityGraphic").innerHTML +=
    "<img src='images/BuildingBlock1.png' alt='Storage'>";
}
...
function storeBuild() {
  ...
  document.getElementById("city").innerHTML =
    " You have " + buildings + " Buildings in your city!";
  document.getElementById("cityGraphic").innerHTML +=
    "<img src='images/BuildingBlock3.png' alt='Store'>";
}
// fourth button
function advertBuild() {
  console.log("Advert is working");
  // add one variable
  buildings++;
  document.getElementById("city").innerHTML =
    " You have " + buildings + " Buildings in your city!";
  document.getElementById("cityGraphic").innerHTML +=
    "<img src='resources/FreeSample/Advertising5crop.png' alt='Advert'>";
}
